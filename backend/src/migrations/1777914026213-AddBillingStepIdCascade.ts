...
export class AddBillingStepIdCascade1777914026213 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`billings\` ADD CONSTRAINT \`FK_54f2503187765fd4b4658b4751a\` FOREIGN KEY (\`step_id\`) REFERENCES \`steps\`(\`id\`) ON DELETE SET NULL ON UPDATE NO ACTION`);
    }
