# Feature: Delete Billing

## Feature summary

Permanently deletes a billing record. Only ADMIN and MANAGER roles can delete.
...
### In scope
- Core delete billing functionality
...
1. User initiates delete billing action
2. System validates request and permissions
3. System processes delete billing operation
...
- Valid request successfully completes delete billing operation
...
- `DELETE /billings/:id`: Handles delete billing operation
...
**Logs/events:**
- delete billing operations should be logged
- Failed attempts can be logged
- Error conditions should be logged

**Metrics (optional):**
- delete billing operation frequency
