...
Updates an existing category record. Allows modification of category name and step templates.
...
### In scope
- Core update category functionality
...
1. User initiates update category action
2. System validates request and permissions
3. System processes update category operation
...
- Valid request successfully completes update category operation
...
- `PATCH /categories/:id`: Handles update category operation
...
**Logs/events:**
- update category operations should be logged
- Failed attempts can be logged
- Error conditions should be logged

**Metrics (optional):**
- update category operation frequency
