# Feature: Get States By Country

## Feature summary

Retrieves all states for a specific country. Returns state list filtered by country ID.
...
### In scope
- Core get states by country functionality
...
1. User initiates get states by country action
2. System validates request and permissions
3. System processes get states by country operation
...
- Valid request successfully completes get states by country operation
...
- `GET /address/countries/:countryId/states`: Handles get states by country operation
...
**Logs/events:**
- get states by country operations should be logged
- Failed attempts can be logged
- Error conditions should be logged

**Metrics (optional):**
- get states by country operation frequency
