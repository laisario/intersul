...
Permanently deletes a service record from the system. Only ADMIN and MANAGER roles can delete. May cascade to related steps.
...
### In scope
- Core delete service functionality
...
1. User initiates delete service action
2. System validates request and permissions
3. System processes delete service operation
...
- Valid request successfully completes delete service operation
...
- `DELETE /services/:id`: Handles delete service operation
...
**Logs/events:**
- delete service operations should be logged
- Failed attempts can be logged
- Error conditions should be logged

**Metrics (optional):**
- delete service operation frequency
