# Feature: Get My Steps

## Feature summary

Retrieves all steps assigned to the current authenticated user. Supports optional date filters (created_today, expires_today, expired).
...
### In scope
- Core get my steps functionality
...
1. User initiates get my steps action
2. System validates request and permissions
3. System processes get my steps operation
...
- Valid request successfully completes get my steps operation
...
- `GET /steps/my-steps`: Handles get my steps operation
...
**Logs/events:**
- get my steps operations should be logged
- Failed attempts can be logged
- Error conditions should be logged

**Metrics (optional):**
- get my steps operation frequency
