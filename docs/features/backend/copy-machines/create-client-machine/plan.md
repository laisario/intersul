# Feature: Create Client Machine

## Feature summary

Creates a new client copy machine record. Associates a copy machine (from catalog or external) with a client for rental, sale, or maintenance tracking.
...
### In scope
- Core create client machine functionality
...
1. User initiates create client machine action
2. System validates request and permissions
3. System processes create client machine operation
...
- Valid request successfully completes create client machine operation
...
- `POST /copy-machines/client`: Handles create client machine operation
...
**Logs/events:**
- create client machine operations should be logged
- Failed attempts can be logged
- Error conditions should be logged

**Metrics (optional):**
- create client machine operation frequency
