# Feature: List Sold Machines

## Feature summary

Retrieves paginated list of sold copy machines. Filters machines by acquisition type SOLD. Supports client filtering.
...
### In scope
- Core list sold machines functionality
...
1. User initiates list sold machines action
2. System validates request and permissions
3. System processes list sold machines operation
...
- Valid request successfully completes list sold machines operation
...
- `GET /copy-machines/sold`: Handles list sold machines operation
...
**Logs/events:**
- list sold machines operations should be logged
- Failed attempts can be logged
- Error conditions should be logged

**Metrics (optional):**
- list sold machines operation frequency
