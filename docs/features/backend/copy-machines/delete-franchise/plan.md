# Feature: Delete Franchise

## Feature summary

Permanently deletes a franchise plan. May fail if franchise is in use by client machines.
...
### In scope
- Core delete franchise functionality
...
1. User initiates delete franchise action
2. System validates request and permissions
3. System processes delete franchise operation
...
- Valid request successfully completes delete franchise operation
...
- `DELETE /copy-machines/franchise/:id`: Handles delete franchise operation
...
**Logs/events:**
- delete franchise operations should be logged
- Failed attempts can be logged
- Error conditions should be logged

**Metrics (optional):**
- delete franchise operation frequency
