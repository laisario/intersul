# Feature: List Catalog Machines

## Feature summary

Retrieves paginated list of catalog machines with optional search. Returns machines with images and features.
...
### In scope
- Core list catalog machines functionality
...
1. User initiates list catalog machines action
2. System validates request and permissions
3. System processes list catalog machines operation
...
- Valid request successfully completes list catalog machines operation
...
- `GET /copy-machines/catalog`: Handles list catalog machines operation
...
**Logs/events:**
- list catalog machines operations should be logged
- Failed attempts can be logged
- Error conditions should be logged

**Metrics (optional):**
- list catalog machines operation frequency
