# Feature: Delete Client Machine

## Feature summary

Permanently deletes a client copy machine record. May fail if machine has associated services.
...
### In scope
- Core delete client machine functionality
...
1. User initiates delete client machine action
2. System validates request and permissions
3. System processes delete client machine operation
...
- Valid request successfully completes delete client machine operation
...
- `DELETE /copy-machines/client/:id`: Handles delete client machine operation
...
**Logs/events:**
- delete client machine operations should be logged
- Failed attempts can be logged
- Error conditions should be logged

**Metrics (optional):**
- delete client machine operation frequency
