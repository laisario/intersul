# Feature: Update Franchise

## Feature summary

Updates an existing franchise plan. Allows modification of franchise details, pricing, and features.
...
### In scope
- Core update franchise functionality
...
1. User initiates update franchise action
2. System validates request and permissions
3. System processes update franchise operation
...
- Valid request successfully completes update franchise operation
...
- `PATCH /copy-machines/franchise/:id`: Handles update franchise operation
...
**Logs/events:**
- update franchise operations should be logged
- Failed attempts can be logged
- Error conditions should be logged

**Metrics (optional):**
- update franchise operation frequency
