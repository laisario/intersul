# Feature: Update Catalog Machine

## Feature summary

Updates an existing catalog machine. Allows modification of machine details and optional image replacement.
...
### In scope
- Core update catalog machine functionality
...
1. User initiates update catalog machine action
2. System validates request and permissions
3. System processes update catalog machine operation
...
- Valid request successfully completes update catalog machine operation
...
- `PATCH /copy-machines/catalog/:id`: Handles update catalog machine operation
...
**Logs/events:**
- update catalog machine operations should be logged
- Failed attempts can be logged
- Error conditions should be logged

**Metrics (optional):**
- update catalog machine operation frequency
