# Feature: Update Client Machine

## Feature summary

Updates an existing client copy machine record. Allows modification of machine details, acquisition type, and status.
...
### In scope
- Core update client machine functionality
...
1. User initiates update client machine action
2. System validates request and permissions
3. System processes update client machine operation
...
- Valid request successfully completes update client machine operation
...
- `PATCH /copy-machines/client/:id`: Handles update client machine operation
...
**Logs/events:**
- update client machine operations should be logged
- Failed attempts can be logged
- Error conditions should be logged

**Metrics (optional):**
- update client machine operation frequency
