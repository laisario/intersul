# Feature: List Rent Machines

## Feature summary

Retrieves paginated list of rented copy machines. Filters machines by acquisition type RENT. Supports client filtering.
...
### In scope
- Core list rent machines functionality
...
1. User initiates list rent machines action
2. System validates request and permissions
3. System processes list rent machines operation
...
- Valid request successfully completes list rent machines operation
...
- `GET /copy-machines/rent`: Handles list rent machines operation
...
**Logs/events:**
- list rent machines operations should be logged
- Failed attempts can be logged
- Error conditions should be logged

**Metrics (optional):**
- list rent machines operation frequency
