# Feature: Get Franchise

## Feature summary

Retrieves a specific franchise plan by ID including complete franchise details.
...
### In scope
- Core get franchise functionality
...
1. User initiates get franchise action
2. System validates request and permissions
3. System processes get franchise operation
...
- Valid request successfully completes get franchise operation
...
- `GET /copy-machines/franchise/:id`: Handles get franchise operation
...
**Logs/events:**
- get franchise operations should be logged
- Failed attempts can be logged
- Error conditions should be logged

**Metrics (optional):**
- get franchise operation frequency
