# Feature: Get Catalog Machine

## Feature summary

Retrieves a specific catalog machine by ID including complete machine details, features, and image.
...
### In scope
- Core get catalog machine functionality
...
1. User initiates get catalog machine action
2. System validates request and permissions
3. System processes get catalog machine operation
...
- Valid request successfully completes get catalog machine operation
...
- `GET /copy-machines/catalog/:id`: Handles get catalog machine operation
...
**Logs/events:**
- get catalog machine operations should be logged
- Failed attempts can be logged
- Error conditions should be logged

**Metrics (optional):**
- get catalog machine operation frequency
