# Feature: Get Client Machines By Client

## Feature summary

Retrieves all copy machines associated with a specific client. Returns machines for rental, sale, or maintenance.
...
### In scope
- Core get client machines by client functionality
...
1. User initiates get client machines by client action
2. System validates request and permissions
3. System processes get client machines by client operation
...
- Valid request successfully completes get client machines by client operation
...
- `GET /copy-machines/client/by-client/:clientId`: Handles get client machines by client operation
...
**Logs/events:**
- get client machines by client operations should be logged
- Failed attempts can be logged
- Error conditions should be logged

**Metrics (optional):**
- get client machines by client operation frequency
