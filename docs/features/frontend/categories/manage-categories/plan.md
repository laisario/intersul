...
Provides interface for managing service categories including creation, editing, and deletion. Includes category form and step template management.

## User value

**What problem it solves:**
- Provides user interface for categories functionality
- Enables users to interact with categories data
...
### In scope
- Core manage categories user interface
...
1. User navigates to /categories (management actions)
2. System fetches required data from API
3. System displays manage categories interface
4. User interacts with manage categories (view, create, edit, etc.)
...
- manage categories interface is displayed correctly
...
- `/categories (management actions)` route page component
...
**Logs/events:**
- manage categories interactions can be logged
- API errors should be logged
- Navigation can be tracked

**Metrics (optional):**
- manage categories view frequency
- Average load time
- Error rate
