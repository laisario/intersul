...
Displays list of copy machines organized by type (catalog, rent, sold, external). Shows machine information and allows filtering by client.
...
### In scope
- Core machine list user interface
...
3. System displays machine list interface
4. User interacts with machine list (view, create, edit, etc.)
...
- machine list interface is displayed correctly
...
**Logs/events:**
- machine list interactions can be logged
- API errors should be logged
- Navigation can be tracked

**Metrics (optional):**
- machine list view frequency
- Average load time
- Error rate
