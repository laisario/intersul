...
Provides form interface for creating new clients. Includes address form with location selection and client information fields.
...
### In scope
- Core create client user interface
...
1. User navigates to /clients (create action)
2. System fetches required data from API
3. System displays create client interface
4. User interacts with create client (view, create, edit, etc.)
...
- create client interface is displayed correctly
...
- `/clients (create action)` route page component
...
**Logs/events:**
- create client interactions can be logged
- API errors should be logged
- Navigation can be tracked

**Metrics (optional):**
- create client view frequency
- Average load time
- Error rate
