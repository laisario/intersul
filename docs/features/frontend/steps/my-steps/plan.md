...
Displays list of steps assigned to the current user. Supports filtering by date (created_today, expires_today, expired) and shows step status and service context.
...
1. User navigates to Dashboard or /steps
2. System fetches required data from API
3. System displays my steps interface
4. User interacts with my steps (view, create, edit, etc.)
...
- my steps interface is displayed correctly
...
- `Dashboard or /steps` route page component
...
**Logs/events:**
- my steps interactions can be logged
- API errors should be logged
- Navigation can be tracked

**Metrics (optional):**
- my steps view frequency
- Average load time
- Error rate
