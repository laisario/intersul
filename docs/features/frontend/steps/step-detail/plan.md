...
Displays detailed view of a specific step including step information, service context, assigned responsable, status, images, and action buttons (start, conclude, cancel).

## User value

**What problem it solves:**
- Provides user interface for steps functionality
- Enables users to interact with steps data
...
### In scope
- Core step detail user interface
...
1. User navigates to /steps/[id]
2. System fetches required data from API
3. System displays step detail interface
4. User interacts with step detail (view, create, edit, etc.)
...
- step detail interface is displayed correctly
...
**Logs/events:**
- step detail interactions can be logged
- API errors should be logged
- Navigation can be tracked

**Metrics (optional):**
- step detail view frequency
- Average load time
- Error rate
