...
Provides interface for managing users including user creation via invitations, user editing, status toggling, and user deletion.

## User value

**What problem it solves:**
- Provides user interface for users functionality
- Enables users to interact with users data
...
### In scope
- Core manage users user interface
...
1. User navigates to /admin/users (management actions)
2. System fetches required data from API
3. System displays manage users interface
4. User interacts with manage users (view, create, edit, etc.)
...
- manage users interface is displayed correctly
...
- `/admin/users (management actions)` route page component
...
**Logs/events:**
- manage users interactions can be logged
- API errors should be logged
- Navigation can be tracked

**Metrics (optional):**
- manage users view frequency
- Average load time
- Error rate
