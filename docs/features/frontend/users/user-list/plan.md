...
Displays list of all users in the system with optional filters (role, active status). Shows user information and allows user management actions.
...
1. User navigates to /users or /admin/users
2. System fetches required data from API
3. System displays user list interface
4. User interacts with user list (view, create, edit, etc.)
...
- user list interface is displayed correctly
...
- `/users or /admin/users` route page component
...
**Logs/events:**
- user list interactions can be logged
- API errors should be logged
- Navigation can be tracked

**Metrics (optional):**
- user list view frequency
- Average load time
- Error rate
