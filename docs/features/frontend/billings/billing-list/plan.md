...
Displays paginated list of billings with optional filters (city, client). Shows billing information including client, copy machine, date, and responsible user.
...
### In scope
- Core billing list user interface
...
1. User navigates to /billings
2. System fetches required data from API
3. System displays billing list interface
4. User interacts with billing list (view, create, edit, etc.)
...
- billing list interface is displayed correctly
...
**Logs/events:**
- billing list interactions can be logged
- API errors should be logged
- Navigation can be tracked

**Metrics (optional):**
- billing list view frequency
- Average load time
- Error rate
